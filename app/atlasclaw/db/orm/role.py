...
class RoleService:
    ...
    async def ensure_builtin_roles(session: AsyncSession) -> None:
        """Ensure built-in roles exist for admin UI workflows."""
